...
{
    public partial class DP173_Single_Engineering_Mornitoring : Form
    {
        ...
        private static DP173_Single_Engineering_Mornitoring Instance;
        public static DP173_Single_Engineering_Mornitoring getInstance()
        {
            if (Instance == null)
                Instance = new DP173_Single_Engineering_Mornitoring();
            return Instance;
        }
        private DP173_Single_Engineering_Mornitoring()
        {
            InitializeComponent();
        }
        ...
        private void DP173_Single_Engineering_Mornitoring_Load(object sender, EventArgs e)
        {
            f1().OC_Param_load();
        ...
        public void Force_Triger_Band_Set_CheckedChanged_Function(int band)
        {
            if (band > 11) MessageBox.Show("Band is out of boundary (band > 11)");
        ...
        public void dataGridView_Gamma_Vreg1_Diff_Set_Init_Vreg1(int band, int Vreg1,bool calculated = false)
        {
            if (band < 10)
            {
                if (calculated) dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (0 + 2)].Cells[12].Value = Vreg1;
                else dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (0 + 2)].Cells[4].Value = Vreg1;
            }
        }


        public void dataGridView_Gamma_Vreg1_Diff_Set_Diff_Vreg1(int band, int Diff_Vreg1,bool calculated = false)
        {
            if (band < 10)
            {
                if (calculated) dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (0 + 2)].Cells[16].Value = Diff_Vreg1;
                else dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (0 + 2)].Cells[8].Value = Diff_Vreg1;
            }
        }

        public void dataGridView_Gamma_Vreg1_Diff_Set_Init_RGB(int band, int gray, RGB Init_Gamma,bool calculated = false)
        {
            if (calculated)
            {
                dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[9].Value = Init_Gamma.R;
                dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[10].Value = Init_Gamma.G;
                dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[11].Value = Init_Gamma.B;
            }
            else
            {
                dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[1].Value = Init_Gamma.R;
                dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[2].Value = Init_Gamma.G;
                dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[3].Value = Init_Gamma.B;
            }
        ...
        public void dataGridView_Gamma_Vreg1_Diff_Set_Diff_RGB(int band, int gray, int Diff_R, int Diff_G, int Diff_B, bool calculated = false)
        {
            if (calculated)
            {
                dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[13].Value = Diff_R;
                dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[14].Value = Diff_G;
                dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[15].Value = Diff_B;
            }
            else
            {
        ...
        public void Get_Gamma_Only_DP173(int band, int gray, ref int Gamma_R, ref int Gamma_G, ref int Gamma_B)
        {
        ...
        public void Set_OC_Param_DP173(int gray, int Gamma_R, int Gamma_G, int Gamma_B, double Measure_X, double Measure_Y, double Measure_Lv, int loop_count, string Extension_Applied)
        {
        ...
        //Single
        public string Get_BX_GXXX_By_Gray_DP173(int gray)
        {
            return dataGridView_Band_OC_Viewer.Rows[gray + 2].Cells[0].Value.ToString();
        }

        public RGB DP173_Get_Gamma(int gray)
        {
            RGB Gamma = new RGB();
            Gamma.int_R = Convert.ToInt16(dataGridView_Band_OC_Viewer.Rows[gray + 2].Cells[1].Value.ToString());
            Gamma.int_G = Convert.ToInt16(dataGridView_Band_OC_Viewer.Rows[gray + 2].Cells[2].Value.ToString());
            Gamma.int_B = Convert.ToInt16(dataGridView_Band_OC_Viewer.Rows[gray + 2].Cells[3].Value.ToString());
        ...
        public void DP173_Get_All_Band_Gray_Gamma(RGB[,] Gamma)
        {
            for (int band = 0; band < 14; band++)
            {
                for (int gray = 0; gray < 8; gray++)
        ...
        public void Set1_HBM_Update_Gamma(RGB[] Gamma)
        {
            ...
            {
                dataGridView_Band_OC_Viewer.Rows[gray + 2].Cells[1].Value = Gamma[gray].int_R;
                dataGridView_Band_OC_Viewer.Rows[gray + 2].Cells[2].Value = Gamma[gray].int_G;
                dataGridView_Band_OC_Viewer.Rows[gray + 2].Cells[3].Value = Gamma[gray].int_B;
            }
            dataGridView_Band_OC_Viewer.Rows[7 + 2].Cells[1].Value = Gamma[8].int_R;
            dataGridView_Band_OC_Viewer.Rows[7 + 2].Cells[2].Value = Gamma[8].int_G;
            dataGridView_Band_OC_Viewer.Rows[7 + 2].Cells[3].Value = Gamma[8].int_B;
        }
        ...
        private void Engineer_Mode_Grid_Tema_Change()
        {
            ...
            for (int i = 9; i <= 12; i++)
            {
                dataGridView_Gamma_Vreg1_Diff.Columns[i].DefaultCellStyle.BackColor = System.Drawing.Color.LightBlue;
                dataGridView_Gamma_Vreg1_Diff.Columns[i].DefaultCellStyle.ForeColor = System.Drawing.Color.Black;
                dataGridView_Gamma_Vreg1_Diff.Columns[i].HeaderCell.Style.Font = new Font(this.Font, System.Drawing.FontStyle.Bold);
                dataGridView_Gamma_Vreg1_Diff.Columns[i].HeaderCell.Style.Alignment = DataGridViewContentAlignment.TopCenter;
                dataGridView_Gamma_Vreg1_Diff.Columns[i].Width = 40;
            ...
            for (int i = 13; i <= 16; i++)
            {
                dataGridView_Gamma_Vreg1_Diff.Columns[i].DefaultCellStyle.BackColor = System.Drawing.Color.LightYellow;
                dataGridView_Gamma_Vreg1_Diff.Columns[i].DefaultCellStyle.ForeColor = System.Drawing.Color.Black;
                dataGridView_Gamma_Vreg1_Diff.Columns[i].HeaderCell.Style.Font = new Font(this.Font, System.Drawing.FontStyle.Bold);
                dataGridView_Gamma_Vreg1_Diff.Columns[i].HeaderCell.Style.Alignment = DataGridViewContentAlignment.TopCenter;
                dataGridView_Gamma_Vreg1_Diff.Columns[i].Width = 40;
        ...
        private void Single_Gamma_Read()
        {
            ...
            for (int band = 0; band < 14; band++)
            {
                string Mipi_CMD = "mipi.write 0x39 " + DP173.Get_Gamma_Register_Hex_String(band); //"mipi.write 0x39 0xXX"
        ...
        public void Gamma_Vreg1_Diff_Clear()
        {
            for (int band = 0; band < 14; band++)
            {
                for (int gray = 0; gray < 8; gray++)
                {
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[4].Value = string.Empty;//Ori Vreg1
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[5].Value = string.Empty;//Ori Diff R
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[6].Value = string.Empty;//Ori Diff G
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[7].Value = string.Empty;//Ori Diff B 
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[8].Value = string.Empty;//Ori Diff Vreg1

                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[12].Value = string.Empty;//Cal Vreg1
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[13].Value = string.Empty;//Cal Diff R
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[14].Value = string.Empty;//Cal Diff G
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[15].Value = string.Empty;//Cal Diff B 
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[16].Value = string.Empty;//Cal Diff Vreg1
                }
            }
        }
        ...
        public void dataGridView_Gamma_Vreg1_Diff_Set_All_Init_RGB()
        {
            for (int band = 0; band < 14; band++)
            {
                for (int gray = 0; gray < 8; gray++)
                {
                    ...
                    //Origin
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[1].Value = string.Empty;
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[2].Value = string.Empty;
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[3].Value = string.Empty;
                    
                    //Cal
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[9].Value = string.Empty;
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[10].Value = string.Empty;
                    dataGridView_Gamma_Vreg1_Diff.Rows[band * 8 + (gray + 2)].Cells[11].Value = string.Empty;
                }
            }
        }
