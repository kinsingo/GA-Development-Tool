...
{
	Sub_Get_Intial_R_Vreg1_B_Using_Previous_Band_Method(Dec_AM1_R,Dec_AM1_G,Dec_AM1_B,Vreg1_Dec_Init,Gamma_R,Gamma_B,Selected_Band,Previous_Band_Gamma_Red,Previous_Band_Gamma_Green,Previous_Band_Gamma_Blue,band,band_Target_Lv,Previous_Band_Vreg1_Dec
    ...
    int Prev_Band_Gray255_Gamma_R = Previous_Band_Gamma_Red[0];
	int Gamma_G = Previous_Band_Gamma_Blue[0];
	int Prev_Band_Gray255_Gamma_B = Previous_Band_Gamma_Blue[0];
	DP173_If_One_Of_RGB_Near_Register_Min_Max_Return_Prev_Band_Gamma(Gamma_R,Gamma_G,Gamma_B,Prev_Band_Gray255_Gamma_R,Gamma_G,Prev_Band_Gray255_Gamma_B);
}
...
extern "C" __declspec (dllexport ) void DP173_Gray255_Get_Intial_R_G_B_Using_Previous_Band_Method(int Vreg1,int Dec_AM1_R, int Dec_AM1_G, int Dec_AM1_B,int& Gamma_R,int& Gamma_G,int& Gamma_B, bool* Selected_Band, int* Previous_Band_Gamma_Red, int* Previous_Band_Gamma_Green, int* Previous_Band_Gamma_Blue, int band, double band_Target_Lv, int Previous_Band_Vreg1_Dec
            , double* Previous_Band_Target_Lv, double Voltage_VREG1_REF2047,double Voltage_VREG1_REF1635,double Voltage_VREG1_REF1227,double Voltage_VREG1_REF815,double Voltage_VREG1_REF407,double Voltage_VREG1_REF63,double Voltage_VREG1_REF1)
{
	Sub_Gray255_Get_Intial_R_G_B_Using_Previous_Band_Method(Vreg1,Dec_AM1_R,Dec_AM1_G,Dec_AM1_B,Gamma_R,Gamma_G,Gamma_B,Selected_Band,Previous_Band_Gamma_Red,Previous_Band_Gamma_Green,Previous_Band_Gamma_Blue,band,band_Target_Lv,Previous_Band_Vreg1_Dec
            ,Previous_Band_Target_Lv,Voltage_VREG1_REF2047,Voltage_VREG1_REF1635,Voltage_VREG1_REF1227,Voltage_VREG1_REF815,Voltage_VREG1_REF407,Voltage_VREG1_REF63,Voltage_VREG1_REF1);

    int Prev_Band_Gray255_Gamma_R = Previous_Band_Gamma_Red[0];
	int Prev_Band_Gray255_Gamma_G = Previous_Band_Gamma_Green[0];
	int Prev_Band_Gray255_Gamma_B = Previous_Band_Gamma_Blue[0];
	DP173_If_One_Of_RGB_Near_Register_Min_Max_Return_Prev_Band_Gamma(Gamma_R,Gamma_G,Gamma_B,Prev_Band_Gray255_Gamma_R,Gamma_G,Prev_Band_Gray255_Gamma_B);
}
...
{
    Sub_Get_Initial_Gamma_Fx_3points_Combine_Points_2(Combine_Lv_Ratio,Dec_AM1_R,Dec_AM1_G,Dec_AM1_B,Gamma_R,Gamma_G,Gamma_B,Selected_Band,Band_Gray_Gamma_Red,Band_Gray_Gamma_Green,Band_Gray_Gamma_Blue,Band_Gray_Target_Lv,Current_Band_Dec_Vreg1,
	...
	int Prev_Band_Current_Gray_Gamma_R = Band_Gray_Gamma_Red[(8 * (band - 1)) + gray];
	int Prev_Band_Current_Gray_Gamma_G = Band_Gray_Gamma_Green[(8 * (band - 1)) + gray];
	int Prev_Band_Current_Gray_Gamma_B = Band_Gray_Gamma_Blue[(8 * (band - 1)) + gray];
	DP173_If_One_Of_RGB_Near_Register_Min_Max_Return_Prev_Band_Gamma(Gamma_R,Gamma_G,Gamma_B,Prev_Band_Current_Gray_Gamma_R,Prev_Band_Current_Gray_Gamma_G,Prev_Band_Current_Gray_Gamma_B);
}
...
//Calculate to get R/G/B
void Get_Initial_Gamma_Fx_3points_Combine_Points(int Dec_AM1_R, int Dec_AM1_G, int Dec_AM1_B, int& Gamma_R, int& Gamma_G, int& Gamma_B, bool* Selected_Band, int* Band_Gray_Gamma_Red, int* Band_Gray_Gamma_Green, int* Band_Gray_Gamma_Blue, double* Band_Gray_Target_Lv, int Current_Band_Dec_Vreg1,
            int* Band_Vreg1_Dec, int band, int gray, double Target_Lv, double Prvious_Gray_Gamma_R_Voltage, double Prvious_Gray_Gamma_G_Voltage, double Prvious_Gray_Gamma_B_Voltage,
            double Voltage_VREG1_REF2047, double Voltage_VREG1_REF1635, double Voltage_VREG1_REF1227, double Voltage_VREG1_REF815, double Voltage_VREG1_REF407, double Voltage_VREG1_REF63, double Voltage_VREG1_REF1
            , double Fx_3points_Combine_LV_1, double Fx_3points_Combine_LV_2, double Fx_3points_Combine_LV_3, double Fx_3points_Combine_Lv_Distance)
{
...
void Sub_Gray255_Get_Intial_R_G_B_Using_Previous_Band_Method(int Vreg1,int Dec_AM1_R, int Dec_AM1_G, int Dec_AM1_B,int& Gamma_R,int& Gamma_G,int& Gamma_B, bool* Selected_Band, int* Previous_Band_Gamma_Red, int* Previous_Band_Gamma_Green, int* Previous_Band_Gamma_Blue, int band, double band_Target_Lv, int Previous_Band_Vreg1_Dec
            , double* Previous_Band_Target_Lv, double Voltage_VREG1_REF2047,double Voltage_VREG1_REF1635,double Voltage_VREG1_REF1227,double Voltage_VREG1_REF815,double Voltage_VREG1_REF407,double Voltage_VREG1_REF63,double Voltage_VREG1_REF1)
{
...
void Sub_Get_Intial_R_Vreg1_B_Using_Previous_Band_Method(int Dec_AM1_R, int Dec_AM1_G, int Dec_AM1_B,int& Vreg1_Dec_Init,int& Gamma_R,int& Gamma_B, bool* Selected_Band, int* Previous_Band_Gamma_Red, int* Previous_Band_Gamma_Green, int* Previous_Band_Gamma_Blue, int band, double band_Target_Lv, int Previous_Band_Vreg1_Dec
            , double* Previous_Band_Target_Lv, double Voltage_VREG1_REF2047,double Voltage_VREG1_REF1635,double Voltage_VREG1_REF1227,double Voltage_VREG1_REF815,double Voltage_VREG1_REF407,double Voltage_VREG1_REF63,double Voltage_VREG1_REF1)
{
	if (band >= 1 && Selected_Band[band] == true)
    {
...
void DP173_If_One_Of_RGB_Near_Register_Min_Max_Return_Prev_Band_Gamma(int& Gamma_R,int& Gamma_G,int& Gamma_B,int Prev_Band_Gray255_Gamma_R,int Prev_Band_Gray255_Gamma_G,int Prev_Band_Gray255_Gamma_B)
{
...
void Sub_Get_Initial_Gamma_Fx_3points_Combine_Points_2(double Combine_Lv_Ratio,int Dec_AM1_R, int Dec_AM1_G, int Dec_AM1_B, int& Gamma_R, int& Gamma_G, int& Gamma_B, bool* Selected_Band, int* Band_Gray_Gamma_Red, int* Band_Gray_Gamma_Green, int* Band_Gray_Gamma_Blue, double* Band_Gray_Target_Lv, int Current_Band_Dec_Vreg1,
            int* Band_Vreg1_Dec, int band, int gray, double Target_Lv, double Prvious_Gray_Gamma_R_Voltage, double Prvious_Gray_Gamma_G_Voltage, double Prvious_Gray_Gamma_B_Voltage,
            double Voltage_VREG1_REF2047, double Voltage_VREG1_REF1635, double Voltage_VREG1_REF1227, double Voltage_VREG1_REF815, double Voltage_VREG1_REF407, double Voltage_VREG1_REF63, double Voltage_VREG1_REF1
            , double Fx_3points_Combine_LV_1, double Fx_3points_Combine_LV_2, double Fx_3points_Combine_LV_3, double Fx_3points_Combine_Lv_Distance)
{
