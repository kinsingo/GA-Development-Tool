...
//Calculate and Get Initial R/G/B (Gray191 ~ Gray4(or 1))
...
//Inner Function(Tested But the Get_Initial_Gamma_Fx_3points_Combine_Points_2 is better than this and this should not be applied)
