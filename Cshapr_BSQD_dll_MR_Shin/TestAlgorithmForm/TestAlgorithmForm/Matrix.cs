...
{
    public class SJH_Matrix
    {
        public int[][] Int_MatrixCreate(int rows, int cols)
        {
        ...
        public double[] MatrixCreate(int rows)
        {
            double[] result = new double[rows];
            return result;
        }
        ...
        public double[] MatrixDuplicate(double[] matrix)
        {
            ...
            for (int i = 0; i < matrix.Length; ++i) // copy the value
                    result[i] = matrix[i];
            return result;
        }
        ...
        public double[] Matrix_Multiply(double[][] Matrix_A, double[] Matrix_B)
        {
            // C = A*B
            double[][] A = MatrixDuplicate(Matrix_A);
            double[] B = MatrixDuplicate(Matrix_B);
            double[] C = MatrixCreate(Matrix_A.Length);
